...
namespace BookShop.Pages.Admin.Books
{
    ...
    public class CreateModel : PageModel
    {
        ...
        [MaxLength(100, ErrorMessage = "The Title cannot exceed 100 charachters")]
        public string Title { get; set; } = "";
        
        [BindProperty]
        [Required(ErrorMessage = "The Authors is required")]
        [MaxLength(255, ErrorMessage = "The Authors cannot exceed 255 charachters")]
        public string Authors { get; set; } = "";
        
        [BindProperty]
        [Required(ErrorMessage = "The ISBN is required")]
        [MaxLength(20, ErrorMessage = "The ISBN cannot exceed 20 charachters")]
        ...
        [BindProperty]
        [MaxLength(1000, ErrorMessage = "The Description cannot exceed 1000 charachters")]
